...
class French:
    ...
    def _genregex_inclusive(self, chars: str = r"[\-\.\·]"):
        ...
        self.inclusive_suffix = rf"({firstsuffix}({if_group_then}))"  # pour d'autres utilisation à l'aide de 'fullmatch'. nécessite de ne pas utiliser (?=) à la fin (car alors impossible de fullmatch une string qui doit être suivi par qqch).
